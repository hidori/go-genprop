...
var (
	doNotEdit = "// Code generated by github.com/hidori/go-genprop/cmd/genprop " + pkg.GetVersion() + " DO NOT EDIT."

	initialismFlag    = flag.String("initialism", "id,url,api", "names to which initialism should be applied")
