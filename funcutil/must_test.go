		...
		t.Run(tt.name, func(t *testing.T) {
			if tt.wantPanic {
				assert.Panics(t, func() {
					_ = MustGet1(tt.args.f)
				})
				return
			}

			got := MustGet1(tt.args.f)
...
func TestMustGet2(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if tt.wantPanic {
				assert.Panics(t, func() {
					_, _ = MustGet2(tt.args.f)
				})
				return
			}

			got, got1 := MustGet2(tt.args.f)
			if !assert.Equal(t, tt.want, got) {
				return
			}
...
func TestMustGet3(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if tt.wantPanic {
				assert.Panics(t, func() {
					_, _, _ = MustGet3(tt.args.f)
				})
				return
			}

			got, got1, got2 := MustGet3(tt.args.f)
			if !assert.Equal(t, tt.want, got) {
				return
			}
